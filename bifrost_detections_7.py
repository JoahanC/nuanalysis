...
for idx in tqdm(run_order):
    ...
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/7/{seqid}/event_cl/"):
        if f"5000_flag.txt" in os.listdir(f"../bifrost_data/7/{seqid}/event_cl/"):
...
for idx in tqdm(run_order):
    ...
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/17/{seqid}/event_cl/"):
        if f"5000_flag.txt" in os.listdir(f"../bifrost_data/17/{seqid}/event_cl/"):
...
for idx in tqdm(run_order):
    ...
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/27/{seqid}/event_cl/"):
        if f"5000_flag.txt" in os.listdir(f"../bifrost_data/27/{seqid}/event_cl/"):
