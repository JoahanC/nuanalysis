...
for idx in tqdm(run_order):
    ...
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/5/{seqid}/event_cl/"):
        if f"5000_flag.txt" in os.listdir(f"../bifrost_data/5/{seqid}/event_cl/"):
...
for idx in tqdm(run_order):
    ...
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/15/{seqid}/event_cl/"):
        if f"5000_flag.txt" in os.listdir(f"../bifrost_data/15/{seqid}/event_cl/"):
...
for idx in tqdm(run_order):
    ...
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/25/{seqid}/event_cl/"):
        if f"5000_flag.txt" in os.listdir(f"../bifrost_data/25/{seqid}/event_cl/"):
