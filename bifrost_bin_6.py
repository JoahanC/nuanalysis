    ...
    for idx in run_order:
        ...
        if f"nu{seqid}A01_cl.evt" in os.listdir(f"../bifrost_data/6/{seqid}/event_cl/"):
            if f"nu{seqid}B01_cl.evt" in os.listdir(f"../bifrost_data/6/{seqid}/event_cl/"):
                if f"{dtime}_binning_flag.txt" not in os.listdir(f"../bifrost_data/6/{seqid}/event_cl/"):
    ...
    for idx in run_order:
        ...
        if f"nu{seqid}A01_cl.evt" in os.listdir(f"../bifrost_data/16/{seqid}/event_cl/"):
            if f"nu{seqid}B01_cl.evt" in os.listdir(f"../bifrost_data/16/{seqid}/event_cl/"):
                if f"{dtime}_binning_flag.txt" not in os.listdir(f"../bifrost_data/16/{seqid}/event_cl/"):
