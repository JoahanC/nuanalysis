...
basic_table_fivek_1 = Table.read("ssd1_jan9_5000_mainmask.tbl", format='ipac')
basic_table_onek_1 = Table.read("ssd1_jan9_1000_mainmask.tbl", format='ipac')
basic_table_halfk_1 = Table.read("ssd1_jan9_500_mainmask.tbl", format='ipac')
...
basic_table_fivek_2 = Table.read("ssd2_jan9_5000_mainmask.tbl", format='ipac')
basic_table_onek_2 = Table.read("ssd2_jan9_1000_mainmask.tbl", format='ipac')
basic_table_halfk_2 = Table.read("ssd2_jan9_500_mainmask.tbl", format='ipac')
...
ax.axhspan(ymin = -.15, ymax = .15, alpha=0.4, color="gray")
...
ax.grid()
#plt.show()
plt.savefig("candidate_elimination3.pdf")
plt.savefig("candidate_elimination3.png")
...
cb = plt.colorbar(pixelplot[3], orientation='vertical')
plt.savefig("detection_pixel.pdf")
plt.savefig("detection_pixel.png")

im_range = np.arange(0, 800, 1)
x_pix = np.array(poisson_table_halfk_1['XPIX'], dtype='f2')
y_pix = np.array(poisson_table_halfk_1['YPIX'], dtype='f2')
fig, ax = plt.subplots()
pixelplot = ax.hist2d(x_pix, y_pix, bins = [im_range, im_range], cmap=discrete_cmap(6, "gnuplot2"))
plt.xlim(250, 750)
plt.ylim(250, 750)
...
ax.set_title("Net Detections per Pixel")
cb = plt.colorbar(pixelplot[3], orientation='vertical')
plt.savefig("detection_pixel_poisson.pdf")
plt.savefig("detection_pixel_poisson.png")
