...
for idx in run_order:
    ...
    if f"nu{seqid}A01_cl.evt" in os.listdir(f"../bifrost_data/2/{seqid}/event_cl/"):
        if f"nu{seqid}B01_cl.evt" in os.listdir(f"../bifrost_data/2/{seqid}/event_cl/"):
            if "1000_binning_flag.txt" not in os.listdir(f"../bifrost_data/2/{seqid}/event_cl/"):
...
for idx in run_order:
    ...
    if f"nu{seqid}A01_cl.evt" in os.listdir(f"../bifrost_data/12/{seqid}/event_cl/"):
        if f"nu{seqid}B01_cl.evt" in os.listdir(f"../bifrost_data/12/{seqid}/event_cl/"):
            if "1000_binning_flag.txt" not in os.listdir(f"../bifrost_data/12/{seqid}/event_cl/"):
...
for idx in run_order:
    ...
    if f"nu{seqid}A01_cl.evt" in os.listdir(f"../bifrost_data/22/{seqid}/event_cl/"):
        if f"nu{seqid}B01_cl.evt" in os.listdir(f"../bifrost_data/22/{seqid}/event_cl/"):
            if "1000_binning_flag.txt" not in os.listdir(f"../bifrost_data/22/{seqid}/event_cl/"):
