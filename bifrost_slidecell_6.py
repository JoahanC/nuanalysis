...
for idx in run_order:
    ...
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/6/{seqid}/event_cl/"):
        if f"5000_flag.txt" not in os.listdir(f"../bifrost_data/6/{seqid}/event_cl/"):
...
for idx in run_order:
    object_name = run_order[idx][0]
    seqid = run_order[idx][1]
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/16/{seqid}/event_cl/"):
        if f"5000_flag.txt" not in os.listdir(f"../bifrost_data/16/{seqid}/event_cl/"):
...
for idx in run_order:
    object_name = run_order[idx][0]
    seqid = run_order[idx][1]
    if f"5000_binning_flag.txt" in os.listdir(f"../bifrost_data/26/{seqid}/event_cl/"):
        if f"5000_flag.txt" not in os.listdir(f"../bifrost_data/26/{seqid}/event_cl/"):
